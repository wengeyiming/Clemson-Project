...
public:
  ...
  virtual const Literal* GrEqual(const Literal& rhs) const = 0;
  virtual const Literal* opGrEqual(float) const = 0;
  virtual const Literal* opGrEqual(int) const = 0;
...
public:
  ...
  virtual const Literal* GrEqual(const Literal& rhs) const {
    return rhs.opGrEqual(val);
  }

  virtual const Literal* opGrEqual(float lhs) const {
    const Literal* node;
    if(lhs >= val)
      node = new FloatLiteral(1);
    else
  ...
  virtual const Literal* opGrEqual(int lhs) const {
    const Literal* node;
    if(lhs >= val)
      node = new FloatLiteral(1);
    else
