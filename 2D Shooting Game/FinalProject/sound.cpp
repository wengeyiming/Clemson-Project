  ...
  channels() 
{
  ...
  if (!music) throw string("Couldn't load Scarlet.mp3")+Mix_GetError();

  startMusic();

  sounds.push_back( Mix_LoadWAV("sound/shoot1.wav") );
  sounds.push_back( Mix_LoadWAV("sound/shoot2.wav") );
  sounds.push_back( Mix_LoadWAV("sound/shoot3.wav") );
